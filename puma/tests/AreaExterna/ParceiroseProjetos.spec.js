import ParceirosEProjetos from '../../src/components/AreaExterna/ParceirosEProjetos/parceiros-projetos.js'

describe('Parceiros E Projetos data', () => {
    it('Should get Parceiros E Projetos data', () => {
        let response = {
            infoParceiros: [
                {
        ...
        expect(ParceirosEProjetos.data()).toStrictEqual(response);
    })
})
